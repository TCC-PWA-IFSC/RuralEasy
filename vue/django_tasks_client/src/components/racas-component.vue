<template>
    <div class="container">
      ...
      <form @submit.prevent="submitForm">
        ...
        <button v-if="isEdit" @click.prevent="deleteRaca">Excluir</button>
    ...
    <tbody>
      <tr v-for="raca in racas" :key="raca.id">
        <td>{{ raca.nomeRaca }}</td>
        <td>
          <button @click.prevent="editRaca(raca)">Editar</button>
          <button @click.prevent="confirmDelete(raca)">Excluir</button>
        </td>
      </tr>
    </tbody>
  </table>
...
<div class="botaoConfirmaDelete" v-if="showDeleteModal">
      ...
      <button @click.prevent="deleteRacaConfirmed">Sim</button>
